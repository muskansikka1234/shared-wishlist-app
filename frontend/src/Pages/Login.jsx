...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
        <h1 onClick={()=> navigate('/')} className="absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer font-bold text-blue-800 whitespace-nowrap text-lg sm:text-xl "> Wishlist App </h1>
    ...
    <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
        ...
        <form onSubmit = {onSubmitHandler}>
            ...
            {state === 'Sign up' ? (
                 <p className='text-gray-400 text-center text-xs mt-4'>Already hava an account?{' '}
                <span onClick={()=> setState('Login')} className="text-blue-400 cursor-pointer underline">Login here</span>
            </p>

            ) : (
                <p className='text-gray-400 text-center text-xs mt-4'>Don't hava an account?{' '}
